...
def embed_figures_in_body(body_content: str, figure_items: list[dict[str, str]], output_lang: str) -> str:
    ...
    if not missing_items:
        return renumber_figures(body_content, figure_items)
    ...
    return renumber_figures(body_content, figure_items, output_lang)
...
def renumber_figures(body_content: str, figure_items: list[dict[str, str]], output_lang: str = "zh-CN") -> str:
